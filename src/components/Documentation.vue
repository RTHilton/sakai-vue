		...
		<div class="col-12">
			<div class="card docs">
				...
				<p>
					...
					<a href="https://cli.vuejs.org/">Vue CLI</a> that provides out-of-the-box standard
					tooling for Vue projects. To get started, clone the
					<a href="https://github.com/primefaces/sakai-vue">repository</a> from GitHub and install the dependencies with npm or yarn.
				</p>
...
yarn
				...
				<p>
					...
					<i>http://localhost:8080/</i> to view the application.
...
"npm run test:unit": Runs the tests.
				...
				<p>
					...
					<i>App.vue</i> inside src folder is the main component containing the template for the base layout
					whereas required resources such as SASS structure for the layout are placed inside the
					<b>src/assets/</b> folder.
				</p>

				<h5>Layout Components</h5>
				<p>
					Main layout is the template of the
					<i>App.vue</i>, it is divided into a couple of child components such as topbar, menu and footer. Here is template of the
				...
				<p>
					...
					<i>AppMenu.vue</i> file based on PrimeVue MenuModel API. In order to define the menuitems,
					navigate to data section of
					<i>App.vue</i> file and define your own model as a nested structure using the
					<i>menu</i> property.
				</p>
...
<code>
{
    ...
    "primeflex": "~3.0.0",
				...
				<p>
					...
					<i>_variables.scss</i> file under src/layout folder. Saving the changes
